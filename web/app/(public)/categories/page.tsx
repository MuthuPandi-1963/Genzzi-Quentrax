    ...
    <div className="min-h-screen bg-background text-foreground pt-24 pb-20 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 relative">
          ...
          >
            Browse <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">Categories</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl border border-black/10 dark:border-white/10 bg-white dark:bg-white/5 focus:ring-2 focus:ring-purple-500/50 outline-none transition-all text-lg shadow-sm"
            />
          </div>
          <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 font-medium hover:bg-gray-50 dark:hover:bg-white/10 transition-colors shadow-sm">
