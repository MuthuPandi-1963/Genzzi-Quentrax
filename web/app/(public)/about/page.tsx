...
const ValueCard = ({ icon: Icon, title, description, delay }: { icon: React.ElementType; title: string; description: string; delay: number }) => (
  ...
  >
    <div className="flex items-center justify-center h-14 w-14 rounded-xl bg-linear-to-br from-primary/20 to-accent/20 text-primary mx-auto">
...
export default function AboutUsPage() {
  ...
  const teamMembers = [
    { name: 'Alice Johnson', role: 'Founder & CEO', avatarColor: 'bg-linear-to-br from-indigo-500 to-indigo-600' },
    { name: 'Brian Smith', role: 'Lead Developer', avatarColor: 'bg-linear-to-br from-green-500 to-emerald-600' },
    { name: 'Carla Ruiz', role: 'UX Designer', avatarColor: 'bg-linear-to-br from-amber-500 to-orange-600' },
    { name: 'David Kim', role: 'Marketing Head', avatarColor: 'bg-linear-to-br from-rose-500 to-pink-600' },
  ];
  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <section className="relative overflow-hidden bg-linear-to-br from-primary/5 via-background to-accent/5 pt-20 pb-16 md:pt-24 md:pb-20">
        ...
        >
          ...
          >
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="px-6 py-3 rounded-xl bg-linear-to-r from-primary to-accent text-white font-semibold shadow-lg shadow-primary/25"
            >
              Get Started
            </motion.button>
            <motion.button
