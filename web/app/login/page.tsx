...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Demo: Show MFA after password validation
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img src="/logo.png" alt="Quentrax" className="w-full h-full object-contain drop-shadow-2xl" />
            {isDark && (
              <motion.div
            ...
            >
              ...
              >
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  <span className={`text-sm ${isDark ? "text-white/60" : "text-gray-500"}`}>Remember me</span>
                </label>
                <Link
                  href="/forgot-password"
                  className={`text-sm font-medium transition-colors hover:underline ${
                    isDark ? "text-[hsl(263,70%,58%)] hover:text-[hsl(263,70%,70%)]" : "text-[hsl(263,70%,50%)]"
                  }`}
                >
                  Forgot password?
                </Link>
              ...
              >
                ...
                <div className="relative flex justify-center text-xs">
                  <span className={`px-4 ${isDark ? "bg-[hsl(260,45%,7%)] text-white/40" : "bg-white text-gray-400"}`}>
                    or continue with
                  </span>
                </div>
              </motion.div>
            ...
            >
                ...
                {[0, 1, 2, 3, 4, 5].map((i) => (
                  <motion.input
                    ...
                    className={`w-12 h-14 text-center text-2xl font-bold rounded-xl border-2 transition-all ${
                      isDark
                        ? "bg-white/5 border-white/20 text-white focus:border-[hsl(263,70%,58%)] focus:shadow-[0_0_20px_hsl(263,70%,58%/0.3)]"
                        : "bg-white border-gray-200 text-gray-800 focus:border-[hsl(263,70%,58%)] focus:shadow-[0_0_20px_hsl(263,70%,58%/0.2)]"
                    }`}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.button
                  ...
                  className="gradient-primary flex-[2] py-3 rounded-xl text-sm font-bold disabled:opacity-50"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
